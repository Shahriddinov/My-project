...
export default function about() {
	return (
		<div className="about">
			<div className="about_Title">Hur vi hjälper kommuner att effektivisera sitt arbete och öka samsynen i beslutsfattandet</div>
			<div className="about_flex">
				<div className="about_flex_left">
					<img className="left_imgs" src={AboutImg} alt="About" />
				</div>
      ...
      <div className="about_interested">
					<div className="about_interested_box">
